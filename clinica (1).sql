...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Abr-2024 às 04:45
...
INSERT INTO `medicos` (`medico_id`, `nome`, `especialidade`, `email`, `senha`) VALUES
(1, 'Fernando', 'Geral', 'fernando@gmail.com', '12345');
...
--
ALTER TABLE `medicos`
  MODIFY `medico_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
